...
public class LoginCheck extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String dbfname = null,dblname =null,dbaddress =null,dbnic=null,dbgender=null,dbdob =null, dbemail =null,dbphoneno=null,dbaccountno=null,dbamount =null,dbuser =null, dbpassword =null;
		...
		if (conn == null)
			...
			String message=null;
			String sql = "select Fname,Lname, Address, NIC, Gender, DOB, Email, PhoneNo, AccountNo, Amount, UserName,Password from customer where UserName ='"+uname+"'";
			...
			try {
				...
				while (rs.next()) {
					...
					dbaccountno = (rs.getString(9));
					dbamount = (rs.getString(10));
					dbuser = (rs.getString(11));
					dbpassword = (rs.getString(12));
					count += 1;
				}
				...
				if (count == 1 && dbuser.equals(uname) && dbpassword.equals(password)) {
					...
					session.setAttribute("AccountNo", dbaccountno);
					session.setAttribute("Amount", dbamount);
